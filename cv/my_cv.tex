...
\vspace{1mm}
\small{
Weiqin Wang is currently a master's student at the College of Computer Science and Software Engineering, Shenzhen University (admitted through the 2025 recommended exemption program), advised by Assistant Professor \href{https://ylwangy.github.io/}{Yile Wang}. His research interests include artificial intelligence, natural language processing, and large language models.
}
% \vspace{-1mm}
\vspace{1mm}
...
\section{\textbf{Education}}
    ...
    {M.Sc. Candidate in Computer Science and Technology}{Sept. 2025 -- June 2028}
    \text{Advisor: Assistant Prof. \href{https://ylwangy.github.io/}{Yile Wang}}

    \resumeSubheading
    {Fujian Agriculture and Forestry University}{Fuzhou, China}
    {B.Sc. in Computer Science and Technology}{Sept. 2021 -- June 2025}
    \text{Overall ranking: 1/128; GPA ranking: 3/128}
...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \item Worked under the supervision of Assistant Prof. \href{https://ylwangy.github.io/}{Yile Wang}.
...
\vspace{0.5mm}
\resumeItemListStart
  \item Kaijie Zheng*, \textbf{Weiqin Wang*}, Yile Wang, \& Hui Huang. \href{https://arxiv.org/abs/2605.29751}{DySem: Uncovering Dynamic Semantic Components of Large Language Models for Calculating Semantic Textual Similarity}. \textit{arXiv preprint arXiv:2605.29751}. [\href{https://github.com/szu-tera/DySem}{code}]
  \item Ziyang Chen, Zhenxuan Huang, Yile Wang, \textbf{Weiqin Wang}, Lu Yin, \& Hui Huang. \href{https://arxiv.org/abs/2601.05075}{SemPA: Improving Sentence Embeddings of Large Language Models through Semantic Preference Alignment}. \textit{To appear in Findings of the 64th Annual Meeting of the Association for Computational Linguistics (ACL Findings)}, 2026. [\href{https://github.com/szu-tera/SemPA}{code}]
  \item \textbf{Weiqin Wang}, Yile Wang, Kehao Chen, \& Hui Huang. \href{https://arxiv.org/abs/2512.15146}{Beyond Majority Voting: Towards Fine-grained and More Reliable Reward Signal for Test-Time Reinforcement Learning}. \textit{To appear in Main Conference of the 64th Annual Meeting of the Association for Computational Linguistics (ACL)}, 2026. [\href{https://github.com/szu-tera/SCOPE}{code}]
  \item Zhanyu Shen, Sijie Cheng, Zhicheng Guo, \textbf{Weiqin Wang}, Yile Wang, \& Hui Huang. \href{https://arxiv.org/abs/2604.17377}{AnchorMem: Anchored Facts with Associative Contexts for Building Memory in Large Language Models}. \textit{To appear in Findings of the 64th Annual Meeting of the Association for Computational Linguistics (ACL Findings)}, 2026. [\href{https://github.com/szu-tera/AnchorMem}{code}]
  \item \textbf{Weiqin Wang}, Yile Wang, \& Hui Huang. \href{https://aclanthology.org/2025.findings-acl.744/}{Ranked Voting based Self-Consistency of Large Language Models}. \textit{Findings of the 63rd Annual Meeting of the Association for Computational Linguistics (ACL Findings)}, 2025. [\href{https://github.com/szu-tera/RankedVotingSC}{code}]
\resumeItemListEnd
